...
queueonteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/madonchik123/Test/main/main.lua'))()")
...
local sValues = {true, 30, true, 30, "#32CD32", 5, true, "https://discord.com/api/webhooks/1001242016501485568/TGQS6XOIxgPdD8YflPzhOYqKSAE_E5dqztra1SuLZ8E7kACQJYiWPpwtThS_bPfAqKp4", true, {"Thank you", "Thanks!", "ty :)", "tysm!"}, false, "GOAL: $C / $G", false, "your text here", "#ffffff", true, true, {"Please donate", "I'm so close to my goal!", "donate to me", "please"}, 120}
